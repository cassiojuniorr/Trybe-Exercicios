...
sex();
    ...
    function mous(){
        ...
        dias.addEventListener("mouseover",function(env){
            env.target.style.fontsize = '40px';
            env.target.style.fontWeight = '900';
        })
    };

    function mousO(){
        let dias = document.querySelector("#days");
        dias.addEventListener("mouseout",function(env){
            env.target.style.fontsize = '20px';
            env.target.style.fontWeight = '200';
        })
    };
    mous();
    mousO();
